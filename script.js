...
document.getElementById('votingForm').addEventListener('submit', function(event) {
    ...
    // Tampilkan pesan terima kasih dan kandidat yang dipilih
    document.getElementById('selectedCandidate').textContent = selectedCandidate;
    document.getElementById('thankYouMessage').style.display = 'block';

    // Tampilkan hasil voting
    document.getElementById('voteKandidat1').textContent = localStorage.getItem('voteKandidat1');
    document.getElementById('voteKandidat2').textContent = localStorage.getItem('voteKandidat2');
    document.getElementById('voteKandidat3').textContent = localStorage.getItem('voteKandidat3');
});